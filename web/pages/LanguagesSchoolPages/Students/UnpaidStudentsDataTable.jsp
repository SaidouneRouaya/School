...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Unpaid students list</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box-header">
                        <h3 class="box-title">All unpaid students</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tg:forEach begin="0" end="${unpaidStudents.size() -1}" var="i">

                                <tr>
                                    <td><a href="Profile.j?query=${unpaidStudents[i].id}" >
                                        <c:out value="${unpaidStudents[i].name}"/>
                                        <c:out value="${unpaidStudents[i].familyname}"/>
                                    </a></td>
                                    ...
                                    <td><c:out value="${unpaidStudents[i].subscriptionDate}"/></td>
