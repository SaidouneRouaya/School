                        ...
                        <div class="box-body">
                            ...
                            <div id="printableArea">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tg:forEach items="${teacherSalariesList}" var="item">
                                ...
                                <h4 class="pull-right">Total : ${totalPayTeacher} .00 DZD</h4>
                            </div>
                            <div>

                                <a target="_blank" class="btn btn-default pull-left"
                                   onclick="printDiv('printableArea')"><i class="fa fa-print"></i> Print</a>
                            </div>
                        </div>
                        <!-- /.box-body -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <div class="box-groupOfStudents" id="accordion">
                                    ...
                                    <tg:forEach var="entryPayments" items="${teacherPaymentListSorted1.entrySet()}">
                                                    ...
                                                    <div id="printableArea2">
                                                        <table id="example11"
                                                            ...
                                                            <tg:forEach begin="0" end="${entryPayments.value.size() -1}"
                                                                ...
                                                                <tr>
                                                                    <td><c:out
                                                                            value="${entryPayments.value.get(k).getTeacher().getName()}"/>
                                                                        <c:out value="${entryPayments.value.get(k).getTeacher().getFamilyname()}"/></td>
                                                                    <td><c:out
                                                                            value="${entryPayments.value.get(k).module}"/></td>
                                                                    <td><c:out
                                                                            value="${entryPayments.value.get(k).paymentType}"/></td>
                                                                    <td><c:out
                            ...
                            <div class="col-md-6">
                                <div class="box-groupOfStudents" id="accordion2">
                                    ...
                                    <tg:forEach var="entryPayments" items="${teacherPaymentListSorted2.entrySet()}">
