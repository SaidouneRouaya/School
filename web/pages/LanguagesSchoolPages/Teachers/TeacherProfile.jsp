...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-aqua-active">
                            <div class="col-md-8">
                                <h3 class="widget-user-username">${teacherProfile.name} ${teacherProfile.familyname}</h3>
                                <h5 class="widget-user-desc">Teacher</h5>
                            </div>

                            <div class="col-md-4">

                                <a href="updateTeacher.j?query=${teacherProfile.id}" class="btn btn-app btn-default pull-right">
                        ...
                        <div class="box-body">
                            ...
                            <form>
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td>Full name</td>
                                        <td>${teacherProfile.name} ${teacherProfile.familyname}</td>
                                    </tr>
                                    <tr>
                                        <td>Phone number</td>
                                        <td>${teacherProfile.phoneNumber}</td>
                                    </tr>

                                    <tr>
                                        <td>Employment day</td>
                                        <td>${teacherProfile.employmentDate}</td>
                                    </tr>
                                ...
                                <div>
                                    <a href="deleteTeacher.j" class="btn  bg-red-gradient pull-right"
            ...
            <!-- /.row -->
            <!-- The Modal -->
            <form role="form" method="post" action="deleteTeacher.j?query=${teacherProfile.id}">
